  ...
  const BLUEPRINTS = [
    {
      ...
      graph: {
        ...
        edges: [
          { id: 'DRAFT___sell___SOLD',            source: 'DRAFT',     target: 'SOLD',      label: 'sell',     guards: [], permission: 'data.ticket.create.agency', sideEffects: [], metadata: {} },
          ...
          { id: 'SOLD___cancel___CANCELLED',      source: 'SOLD',      target: 'CANCELLED', label: 'cancel',   guards: [], permission: 'data.ticket.cancel.agency', sideEffects: [], metadata: {} },
          { id: 'VALIDATED___cancel___CANCELLED', source: 'VALIDATED', target: 'CANCELLED', label: 'cancel',   guards: [], permission: 'data.ticket.cancel.agency', sideEffects: [], metadata: {} },
        ],
    ...
    },
    {
      ...
      graph: {
        ...
        edges: [
          { id: 'PLANNED___start_loading___LOADING',       source: 'PLANNED',    target: 'LOADING',    label: 'start_loading',    guards: [], permission: 'data.trip.update.agency',    sideEffects: [], metadata: {} },
          { id: 'LOADING___depart___DEPARTING',            source: 'LOADING',    target: 'DEPARTING',  label: 'depart',           guards: [], permission: 'data.trip.update.agency',    sideEffects: [], metadata: {} },
          { id: 'DEPARTING___confirm_departure___IN_TRANSIT',source:'DEPARTING', target: 'IN_TRANSIT', label: 'confirm_departure',guards: [], permission: 'data.trip.update.agency',    sideEffects: [], metadata: {} },
          { id: 'IN_TRANSIT___arrive___ARRIVED',           source: 'IN_TRANSIT', target: 'ARRIVED',    label: 'arrive',           guards: [], permission: 'data.trip.update.agency',    sideEffects: [], metadata: {} },
          { id: 'ARRIVED___complete___COMPLETED',          source: 'ARRIVED',    target: 'COMPLETED',  label: 'complete',         guards: [], permission: 'data.trip.update.agency',    sideEffects: [], metadata: {} },
          { id: 'PLANNED___cancel___CANCELLED',            source: 'PLANNED',    target: 'CANCELLED',  label: 'cancel',           guards: [], permission: 'control.trip.cancel.tenant', sideEffects: [], metadata: {} },
          { id: 'DEPARTING___report_incident___INCIDENT',  source: 'DEPARTING',  target: 'INCIDENT',   label: 'report_incident',  guards: [], permission: 'control.trip.delay.agency',  sideEffects: [], metadata: {} },
          { id: 'INCIDENT___resolve_incident___IN_TRANSIT',source: 'INCIDENT',   target: 'IN_TRANSIT', label: 'resolve_incident', guards: [], permission: 'data.trip.update.agency',    sideEffects: [], metadata: {} },
        ],
        version: '1.0.0', checksum: '', metadata: {},
      },
    },
    {
      ...
      graph: {
        ...
        edges: [
          { id: 'RECEIVED___process___PROCESSING',              source: 'RECEIVED',         target: 'PROCESSING',       label: 'process',          guards: [], permission: 'data.parcel.scan.agency',   sideEffects: [], metadata: {} },
          { id: 'PROCESSING___dispatch___IN_TRANSIT',           source: 'PROCESSING',       target: 'IN_TRANSIT',       label: 'dispatch',         guards: [], permission: 'data.parcel.update.agency', sideEffects: [], metadata: {} },
          { id: 'IN_TRANSIT___out_for_delivery___OUT_FOR_DELIVERY',source:'IN_TRANSIT',     target: 'OUT_FOR_DELIVERY', label: 'out_for_delivery', guards: [], permission: 'data.parcel.update.agency', sideEffects: [], metadata: {} },
          { id: 'OUT_FOR_DELIVERY___deliver___DELIVERED',       source: 'OUT_FOR_DELIVERY', target: 'DELIVERED',        label: 'deliver',          guards: [], permission: 'data.parcel.update.agency', sideEffects: [], metadata: {} },
          { id: 'OUT_FOR_DELIVERY___return_parcel___RETURNED',  source: 'OUT_FOR_DELIVERY', target: 'RETURNED',         label: 'return_parcel',    guards: [], permission: 'data.parcel.update.agency', sideEffects: [], metadata: {} },
          { id: 'RETURNED___reprocess___RECEIVED',              source: 'RETURNED',         target: 'RECEIVED',         label: 'reprocess',        guards: [], permission: 'data.parcel.update.agency', sideEffects: [], metadata: {} },
        ],
        version: '1.0.0', checksum: '', metadata: {},
      },
    },
    {
      ...
      graph: {
        ...
        edges: [
          { id: 'OPEN___assign___INVESTIGATING',             source: 'OPEN',          target: 'INVESTIGATING', label: 'assign',       guards: [], permission: 'data.sav.claim.tenant', sideEffects: [], metadata: {} },
          { id: 'INVESTIGATING___request_info___PENDING_INFO',source:'INVESTIGATING', target: 'PENDING_INFO',  label: 'request_info', guards: [], permission: 'data.sav.claim.tenant', sideEffects: [], metadata: {} },
          { id: 'PENDING_INFO___provide_info___INVESTIGATING',source:'PENDING_INFO',  target: 'INVESTIGATING', label: 'provide_info', guards: [], permission: 'data.sav.claim.tenant', sideEffects: [], metadata: {} },
          { id: 'INVESTIGATING___resolve___RESOLVED',        source: 'INVESTIGATING', target: 'RESOLVED',      label: 'resolve',      guards: [], permission: 'data.sav.claim.tenant', sideEffects: [], metadata: {} },
          { id: 'RESOLVED___close___CLOSED',                 source: 'RESOLVED',      target: 'CLOSED',        label: 'close',        guards: [], permission: 'data.sav.claim.tenant', sideEffects: [], metadata: {} },
          { id: 'INVESTIGATING___reject___REJECTED',         source: 'INVESTIGATING', target: 'REJECTED',      label: 'reject',       guards: [], permission: 'data.sav.claim.tenant', sideEffects: [], metadata: {} },
        ],
        version: '1.0.0', checksum: '', metadata: {},
      },
    },
    {
      ...
      graph: {
        ...
        edges: [
          { id: 'NORMAL___report___INCIDENT',          source: 'NORMAL',    target: 'INCIDENT',      label: 'report',        guards: [], permission: 'control.trip.delay.agency', sideEffects: [], metadata: {} },
          { id: 'INCIDENT___escalate___ESCALATED',     source: 'INCIDENT',  target: 'ESCALATED',     label: 'escalate',      guards: [], permission: 'control.trip.delay.agency', sideEffects: [], metadata: {} },
          { id: 'ESCALATED___investigate___INVESTIGATING',source:'ESCALATED',target:'INVESTIGATING', label: 'investigate',   guards: [], permission: 'control.trip.delay.agency', sideEffects: [], metadata: {} },
          { id: 'INVESTIGATING___resolve___RESOLVED',  source: 'INVESTIGATING',target:'RESOLVED',    label: 'resolve',       guards: [], permission: 'control.trip.delay.agency', sideEffects: [], metadata: {} },
          { id: 'INCIDENT___close___CLOSED',           source: 'INCIDENT',  target: 'CLOSED',        label: 'close',         guards: [], permission: 'control.trip.delay.agency', sideEffects: [], metadata: {} },
          { id: 'RESOLVED___close___CLOSED',           source: 'RESOLVED',  target: 'CLOSED',        label: 'close',         guards: [], permission: 'control.trip.delay.agency', sideEffects: [], metadata: {} },
        ],
        version: '1.0.0', checksum: '', metadata: {},
      },
    },

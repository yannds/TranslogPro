...
const P = {
  ...
  BRIEFING_TEMPLATE_READ_TENANT:   'data.briefing.template.read.tenant',
  BRIEFING_TEMPLATE_MANAGE_TENANT: 'control.briefing.template.manage.tenant',
  BRIEFING_SIGN_OWN:               'data.briefing.sign.own',
  BRIEFING_SIGN_DELEGATE_AGENCY:   'data.briefing.sign.delegate.agency',
  BRIEFING_READ_AGENCY:            'data.briefing.read.agency',
  BRIEFING_READ_TENANT:            'data.briefing.read.tenant',
  BRIEFING_OVERRIDE_TENANT:        'control.briefing.override.tenant',
  SAFETY_ALERT_READ_AGENCY:        'data.safety_alert.read.agency',
  SAFETY_ALERT_READ_TENANT:        'data.safety_alert.read.tenant',
  SAFETY_ALERT_RESOLVE_AGENCY:     'control.safety_alert.resolve.agency',
  SAFETY_ALERT_RESOLVE_TENANT:     'control.safety_alert.resolve.tenant',
  // CRM
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { kind: 'leaf', id: 'crew-briefing',          label: 'nav.pre_departure_briefings', href: '/admin/crew/briefing',          icon: 'ClipboardCheck',    anyOf: [P.CREW_MANAGE, P.BRIEFING_READ_AGENCY, P.BRIEFING_READ_TENANT], moduleKey: 'CREW_BRIEFING' },
            { kind: 'leaf', id: 'crew-briefing-template', label: 'nav.briefing_template',       href: '/admin/crew/briefing/template', icon: 'FileSpreadsheet',   anyOf: [P.BRIEFING_TEMPLATE_MANAGE_TENANT, P.BRIEFING_TEMPLATE_READ_TENANT], moduleKey: 'CREW_BRIEFING' },
            { kind: 'leaf', id: 'trip-safety-alerts',     label: 'nav.safety_alerts',           href: '/admin/qhse/safety-alerts',     icon: 'Shield',            anyOf: [P.SAFETY_ALERT_READ_AGENCY, P.SAFETY_ALERT_READ_TENANT], moduleKey: 'CREW_BRIEFING' },
          ],
        },
        {
          kind: 'group',
      ...
      items: [
        {
          ...
          children: [
            ...
            { kind: 'leaf', id: 'pricing-toll-points', label: 'nav.toll_points',      href: '/admin/pricing/toll-points',  icon: 'Coins',      anyOf: [P.ROUTE_MANAGE] },
    ...
    // Composé automatiquement selon les permissions globales de l'acteur.
    {
      ...
      items: [
        ...
        },
        {
          kind: 'leaf',
          id: 'platform-payment',
          label: 'nav.platform_payment',
          href: '/admin/platform/payment',
          icon: 'Coins',
          anyOf: [P.PLATFORM_BILLING_MANAGE],
        },
        {
          ...
          label: 'nav.platform_integrations',

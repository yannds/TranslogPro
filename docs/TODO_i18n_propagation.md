...
| `welcome.task.addBus*`, `welcome.task.planTrip*`, `welcome.task.*.desc`, `welcome.unlock.needsBus`, `welcome.unlock.needsTrip`, `welcome.unlock.needsRoute`, `welcome.gotoDashboard`, `welcome.loading`, `welcome.loadError`, `welcome.retry` | 14 | Refonte WelcomePage — checklist véridique par dépendance | [WelcomePage.tsx](../frontend/components/onboarding/WelcomePage.tsx), [fr.ts](../frontend/lib/i18n/locales/fr.ts), [en.ts](../frontend/lib/i18n/locales/en.ts) — ajouté 2026-04-26 |
| `sellTicket.empty.*` | 6 | Empty state honnête PageSellTicket (aucun trajet → CTA Bus + Trip) | [PageSellTicket.tsx](../frontend/components/pages/PageSellTicket.tsx), [fr.ts](../frontend/lib/i18n/locales/fr.ts), [en.ts](../frontend/lib/i18n/locales/en.ts) — ajouté 2026-04-26 |
